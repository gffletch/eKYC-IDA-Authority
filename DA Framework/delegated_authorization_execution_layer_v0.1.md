...
**Working draft v0.1 — Permissioned Capabilities and Protected Access**
...
**Editorial note (post-v0.1):** This document has been updated to use the renamed execution-layer components — *Permissioned Capabilities* (formerly *Delegated Capabilities*) and *Protected Access* (formerly *Delegated Access*) — and to refer to components by name rather than ordinal number. The rename reflects that "delegated access" is conventionally associated with share-access patterns rather than the broader cross-trust-domain credential pattern intended here.
...
- *Delegated Authorization Reference Architecture v1.1* — the delegation-component model (Relationship, Authority, Obligations, Constraints) this layer executes
